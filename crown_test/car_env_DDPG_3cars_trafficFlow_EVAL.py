...
#### 车辆原始参数
MAX_V = left_max_v #60 / 3.6
TURN_MAX_V = 4.2
TIME_TAG_UP_BOUND = 800    # 秒
...
INIT_CAR_DISTANCE = 25 #20 + STD_MAX_V/2  # 初始时车辆的间隔（原来的25）
...
# define car
class car(object):
    def __init__(self, id, role, tar_interDis, tar_speed, init_location_x, init_speed=0.0, max_v = MAX_V,location=None, ingaged_in_platoon=None, leader=None,
